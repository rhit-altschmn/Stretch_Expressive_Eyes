...
from PyQt5.QtWidgets import QApplication, QWidget, QLabel, QPushButton, QVBoxLayout, QHBoxLayout, QGridLayout, QMainWindow, QStackedWidget
from PyQt5.QtCore import Qt

class CameraController(): # head camera also
    def __init__(self, forwards_scale = 1, backwards_scale = 1, left_scale = 1, right_scale = 1, parent=None):
        ...
        self.keyboard_listener = rospy.Subscriber('/keyboard_input', chr, self.keyboard_cb)
...
class NavigationController(): # base motion
    def __init__(self, forwards_scale = 1, backwards_scale = 1, left_scale = 1, right_scale = 1, parent=None):
        self.areas = [
            {
                "geometry" : shapely.Polygon([(0, 0), (0.5, 0.5), (1, 0)]),
...
class MainCameraController(): #head cam 
    def __init__(self, forwards_scale = 1, backwards_scale = 1, left_scale = 1, right_scale = 1, parent=None):
        self.areas = [
            {
                "geometry" : shapely.Polygon([(0, 0), (0.5, 0.5), (1, 0)]),
...
class Button(QPushButton):
    ...
    def __init__(self, parent=None, dimensions=(700, 95)):
        super(QPushButton, self).__init__(parent)
        self.setFixedSize(dimensions[0], dimensions[1])
...
class CameraButtonSet(QWidget):
    def __init__(self, parent=None):
        ...
        self.main_layout.addWidget(self.up_button,0,1)
        self.main_layout.addWidget(self.down_button,2,1)
        self.main_layout.addWidget(self.left_button,1,0)
        self.main_layout.addWidget(self.right_button,1,2)
...
class ManipulationPage(QWidget):
    def __init__(self):
        ...
        self.main_camera_layout.addWidget(self.navigation_button)
